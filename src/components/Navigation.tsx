        ...
        <div className="flex h-16 sm:h-20 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative group">
              <button className="flex items-center space-x-1 text-foreground hover:text-logo-teal transition-all duration-300 py-2 px-4 rounded-lg border-2 border-logo-teal/30 hover:border-logo-teal/70 hover:bg-logo-teal/5 font-poppins text-xs">
              ...
              <div className="absolute top-full left-0 mt-1 w-64 bg-background border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-2">
                  ...
                  >
                    <div className="font-semibold text-xs text-foreground">Student Twin</div>
                  ...
                  <Link
                    ...
                    className="block px-3 py-2 rounded-md hover:bg-muted transition-colors"
                  >
                    <div className="font-semibold text-xs text-foreground">Adult Twin</div>
                    <div className="text-xs text-muted-foreground">
                  ...
                  <Link
                    ...
                    className="block px-3 py-2 rounded-md hover:bg-muted transition-colors"
                  >
                    <div className="font-semibold text-xs text-foreground">Enterprise Twin</div>
                    <div className="text-xs text-muted-foreground">
                  ...
                  <Link
                    ...
                    className="block px-3 py-2 rounded-md hover:bg-muted transition-colors"
                  >
                    <div className="font-semibold text-xs text-foreground">Twin Workbench</div>
                    <div className="text-xs text-muted-foreground">
                      Your AI's workspace
                    </div>
                  </Link>
            ...
            {/* Education Dropdown */}
            <div className="relative group">
              <button className="flex items-center space-x-1 text-foreground hover:text-logo-blue transition-all duration-300 py-2 px-4 rounded-lg border-2 border-logo-blue/30 hover:border-logo-blue/70 hover:bg-logo-blue/5 text-xs">
              ...
              <div className="absolute top-full left-0 mt-1 w-56 bg-background border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-2">
                  <Link
                    to="/education"
                    className="block px-3 py-2 rounded-md hover:bg-muted transition-colors text-xs font-semibold text-foreground"
                  >
                    Overview
                  </Link>
                  <Link
            ...
            {/* Company Dropdown */}
            <div className="relative group">
              <button className="flex items-center space-x-1 text-foreground hover:text-cyber-blue transition-all duration-300 py-2 px-4 rounded-lg border-2 border-cyber-blue/30 hover:border-cyber-blue/70 hover:bg-cyber-blue/5 text-xs">
